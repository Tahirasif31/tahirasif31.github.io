$(function () {
  ...
  $(".multiple-items").slick({
    ...
    slidesToScroll: 2,
    prevArrow:
      '<a href="#" class="prre"><i class="fas fa-angle-double-left"></i>Previous Post</a>',
    nextArrow:
      '<a href="#" class="nxxt">Next Post<i class="fas fa-angle-double-right"></i></a>',
    responsive: [
      {
        breakpoint: 992,
        settings: {
...
function funAlert() {
  alert("Your Query has been sent. We will respond you soon");
}
